...
- Se utiliza la baseUrl:  https://petstore.swagger.io/v2  y se configura en karate-config.js
- Los request bodies se leen desde JSON en src/test/resources/testdata/
- Se usa callonce para crear una mascota (newPet.feature), se captura y reutiliza el petId en escenarios posteriores (petstore.feature).